 ...
 * and the project supplies no 404.html of its own.
 *
 ...
 *
 * IMPORTANT: keep in sync with the duplicate in
 * packages/worker/src/not-found-page.ts. The publisher worker cannot import
 * from packages/app, so the two copies are maintained by hand.
 */
